...
class LangHelper {
    ...
    public static function getMessage(string $key, Modules $module, string $language = null) {
        ...
        $messages = json_decode(file_get_contents(base_path("App" . DIRECTORY_SEPARATOR . "Modules" . DIRECTORY_SEPARATOR . $module->value . DIRECTORY_SEPARATOR . "Messages" . DIRECTORY_SEPARATOR . $language . ".json")), true);
