...
class LessonsServiceImpl implements ILessonsService {
    ...
    {
        return $this->lessonsRepo->createLesson($lessonTitle, $lessonDescription, $lessonCode, $lessonSectionId, $lessonPractice, $lang);
    }
    ...
    {
        return $this->lessonsRepo->updateLesson($lessonTitle, $lessonDescription, $lessonCode, $lessonPractice, $lang, $lesson);
    }
    ...
    public function updateLessonVideoLink(string $lessonVideoLink, int $lessonId, string $lang): Lesson {
        return $this->lessonsRepo->updateLessonVideo($lessonVideoLink, $this->lessonsRepo->getLessonByLessonId($lessonId), $lang);
    }
    ...
    {
        return $this->lessonsRepo->toggleLessonPublishedStatus($isLessonPublished, $this->lessonsRepo->getLessonByLessonId($lessonId));
    }
