...
class SectionController extends Controller
{
    ...
    public function store(SectionStoreRequest $request): JsonResponse
    {
        return response()->json([
            "data" => $this->sectionsService->createSection(
                $request->input(Section::sectionName())[$request->input("lang")],
                $request->input(Section::sectionCourseId()),
                $request->input("lang")
            )
        ]);
    }
    ...
    {
        return response()->json([
            "data" => $this->sectionsService->updateSection(
                $section,
                $request->input(Section::sectionName())[$request->input("lang")],
                $request->input("lang")
            )
    ...
    {
        $this->sectionsService->reorderSections($request->input("sections"));
